...
public class IdCardUtil {
    ...
    public static void main(final String[] args) {
        final String idCard = "310100198907030246";
        System.out.println(validate(idCard));
        System.out.println(getBirthday(idCard));
        //System.out.println(validateIdCard("123456789012345678"));
        //System.out.println(validateIdCard("31010019890703024C"));
    }
    ...
    private static Boolean isDigital(final String string) {
        return DIGITAL_PATTERN.matcher(string).matches();
    }
    ...
    public static String getSex(@NotNull final String idCard) {
        ...
        final String sex = idCard.substring(17, 18);
